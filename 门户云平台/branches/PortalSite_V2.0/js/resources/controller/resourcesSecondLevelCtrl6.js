	...
	return {
		...
		link: function(scope, element, attrs) {
			...
			function defaultShowFirst(){
				...
				$('.zy_resources_tree_structure').children().first().children('.cxv').children('ul').children().first().children('h2').addClass('active');
			}
//			defaultShowFirst();
...
//			console.log($('.zy_resources_tree_structure').children().first().children('.cxv').children('h2'))
//			$('.zy_resources_tree_structure').children().first().children('.cxv').children('h2').trigger('click')
	    }
	}
});
