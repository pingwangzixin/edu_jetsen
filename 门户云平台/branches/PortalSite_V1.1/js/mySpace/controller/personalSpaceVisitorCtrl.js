app.controller('personalSpaceVisitorCtrl',['$scope','$state','$timeout','$http','$location','$interval','templateServer',function($scope,$state,$timeout,$http,$location,$interval,templateServer) {
	//获取所访问的用户id
...
//	获取说说动态
	...
	//	获取当前人的信息
	$http.get(jeucIp + 'uc/ucUser/'+$location.search().id+'/'+$location.search().type).success(function (data){
		console.log(data);
