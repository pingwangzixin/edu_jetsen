 app.controller('resourcesDetailsCtrl', ['$scope', '$state', '$timeout', '$http', '$location', function($scope, $state, $timeout, $http, $location) {
	...
	//查询资源
	$scope.res;
	var url = resourcesIp + "/edu-resource/a/resource/mrs_rmi/getById?token=29B5DF07F7FC514807CE5FBC12EA1506&id=" + resData.id;
	$.ajax({
		url: url,
		type: 'get',
		dataType: 'json',
...
//					$scope.resourceList = res.list;
		...
		/*//有参url
		var paramUrl = resourcesIp+ "/edu-resource/a/resource/mrs_rmi/getResources?token=29B5DF07F7FC514807CE5FBC12EA1506&pageNo=1";
	...
	var res_player_path = "rtmp://192.168.9.59:1935";
	var res_player_path1 = "http://192.168.9.59:1935";
	var res_player_floder = "vod5/_definst_";
	var res_player_mp4 = "mp4:";
	var res_player_mp3 = "mp3:";
	var server_ip = "192.168.9.122:";
	var server_port = "8018/";
