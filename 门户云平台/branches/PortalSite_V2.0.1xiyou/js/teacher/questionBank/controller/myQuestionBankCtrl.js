...
//			arrSubject:[],
    ...
    */
		...
		if($scope.variablePacket.exercisesAndtest == 0) {
			...
			switch($scope.variablePacket.myQuestionTypeIndex){
				case 0:
				  ...
				  break;
				case 1:
					$scope.findExamList($scope.variablePacket.pageNo,$scope.variablePacket.pageSize,$scope.variablePacket.subjIds,1);
				  break;
				case 2:
					$scope.findExamList($scope.variablePacket.pageNo,$scope.variablePacket.pageSize,$scope.variablePacket.subjIds,2);
				  break;
				case 3:
					$scope.findExamList($scope.variablePacket.pageNo,$scope.variablePacket.pageSize,$scope.variablePacket.subjIds,3);
				  break;
			}
		}
	};
	...
	$scope.insertLine = function (){
		$scope.questionBank.fill.answer += '|';
//		$('#s').focus();
	};
	...
	// 3.我的分享module:2,
	// 4.我的收藏module:3,
	$scope.findExamList = function(pageNo,pageSize,subjIds,module) {
		var params = {current:pageNo,size:pageSize,subjIds:subjIds,module:module,createBy:userId};
