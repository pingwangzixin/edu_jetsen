app.controller('studentClassroomContentCtrl',['$scope','$state','$timeout','$http','$location','$interval','templateServer','scrollbar','$sce','$compile','$stateParams','stuClassroomService',function($scope,$state,$timeout,$http,$location,$interval,templateServer,scrollbar,$sce,$compile,$stateParams,stuClassroomService) {
    ...
    stuClassroomService.lessonOne(params,function (res) {
	...
	$scope.EchotitTab = function(i){
        ...
        if(i == 1 && !$.isEmptyObject(id)){
            ...
            stuClassroomService.lessonComment(param,function (res) {
                console.log(res);
	...
	$scope.askButton = function() {
        ...
        stuClassroomService.putLessonComment(commentParams,function (res) {
            console.log(res);
        },function (err) {
	...
	$scope.renderFinish = function(){
		...
		angular.element(".zyx_contentLine").mCustomScrollbar({
			mouseWheelPixels : 1000,
			theme: "3d-dark"
		});
