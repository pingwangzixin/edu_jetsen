app.controller('schoolPhotoEditCtrl',['$rootScope','$scope','$state','$timeout','$http','$location','$interval','templateServer',function($rootScope,$scope,$state,$timeout,$http,$location,$interval,templateServer) {
	//上传背景隐藏
	...
	$scope.save = function(ueditor){
		var params = {};
		params.relationId = $scope.variable.officeId;
