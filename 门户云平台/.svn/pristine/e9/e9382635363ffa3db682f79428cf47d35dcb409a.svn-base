...
//							valueObject.notLearnAnswer ="";//未学习---答案
					...
					$scope.stuInfo.examAssemblyName = examData.examAssembly[0].name;
...
//							valueObject.notLearnAnswer ="";//未学习---答案
					...
					console.log("答题卡");
					var questionImgList = examData.examAssembly[0].questionImgList;
					$scope.stuInfo.examAssemblyName = examData.examAssembly[0].name;
					var questionMap = examData.examAssembly[0].questionOptionMap;
					$scope.echoQuestion.assembly = examData.examAssembly[0];
					for(var t=0,tlen=questionMap.length; t<tlen; t++){
						var key = questionMap[t].typeId;
						titles+=","+key;
