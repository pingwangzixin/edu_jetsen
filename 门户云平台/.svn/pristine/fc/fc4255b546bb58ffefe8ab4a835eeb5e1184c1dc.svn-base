 ...
 */
app.service('stuClassroomService',['$http','$timeout',function($http,$timeout) {
    ...
    this.stuResource = function (params,succ,err) {
    ...
    //         console.log("参数未传递~");
    //     }
    //     $http.get(lessonIp+"auth/"+url,{params:params}).success(function (res) {
    //         console.log(res);
    ...
    this.getUserByToken = function (url,succ,error) {
    ...
    this.findUserSubject = function (param,succ,err) {
        $http.get(jeucIp+"edu/eduSubject",{params:param}).success(function (res) {
            var data;
            if (res.ret == 200){
                data= res.data;
            }
