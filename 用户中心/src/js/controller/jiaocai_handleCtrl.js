app.controller('jiaocai_handleCtrl',['$scope','$timeout','textBookService','levelGradeMap',function($scope,$timeout,textBookService,levelGradeMap) {
	...
	$scope.findVerByGradeAndSub = function(){
		var params = {levelId:$scope.state.levelId,subjectId:$scope.state.subjectId,gradeNo:''};
	...
	$scope.getNotGrade = function(gradeNo){
		...
		var notInparams = {notIn:'2',levelId:$scope.state.levelId,subjectId:$scope.state.subjectId,gradeNo:gradeNo};
...
//		$scope.state.schoolId = '';
	...
	$scope.changeLevel = function(index,level){
		...
		if(!$scope.state.schoolshowstate){
			$scope.state.subjectList = [];
			//获取学科
			textBookService.getSubjectByLevelId($scope.state.levelId,function(res){
				if(res.ret == 200){
	...
	$scope.subjectChange = function(subject){
		...
		$scope.data = [];
		if(subject != null){
			var params = {subjectId:subject.id,levelId:$scope.state.levelId}
	...
	$scope.saveVersion = function(){
		...
		var params = {levelId:$scope.state.levelId,subjectId:$scope.state.subjectId,createBy:$scope.state.userId};
		var subject = {id:$scope.state.subjectId,name:$scope.state.subjectName};
	...
	$scope.deleteVerLevelSub = function(versionId){
		var params = {levelId:$scope.state.levelId,subjectId:$scope.state.subjectId,versionId:versionId,updateBy:$scope.state.userId};
	...
	$scope.bluraction = function(self){
		...
		var params = {id:self.getAttribute("data-id"),name:verName,updateBy:$scope.state.userId}
