...
//导入也得改
var requireIp = 'http://localhost:8089/jeuc/api'; //ceshi
var token = '29B5DF07F7FC514807CE5FBC12EA1506';
//修改手机号 密码 跳转地址
//var homeAddress = 'http://z.uuke.com.cn';
var homeAddress = 'http://z.uuke.com.cn:8080/#/user/logout';
...
//  //新增管理者接口
//  this.addNewManager = function(param,succ,error){
