    ...
    var chart = $(target).highcharts({
        ...
        tooltip: {
            ...
            formatter: function() {
				...
				'<strong>人均在线时长为'+  this.point.times +'次,</strong><br>'
            }
	    },
        plotOptions: {
            pie: {
...
function chart_pie_tooltip(target,user,title, subtitle, data){
    ...
    var chart = $(target).highcharts({
        chart: { type: 'pie', spacing: [40, 0 , 40, 0], backgroundColor: 'transparent' },
        title: {
            text: title,
            floating:true,
            useHTML: true,
 ...
 * @return {object}          返回 highcharts 对象
 */
function chart_pie_activetooltip(target,title, subtitle, data){
    var style = {
            title: {fontSize: '18px', color: '#586779'},
            subtitle: {fontSize: '40px', color: '#fff'}
        },
    ...
    var chart = $(target).highcharts({
        ...
        tooltip: {
            ...
            formatter: function() {
				return '<strong>'+ this.point.name +'：'  +'</strong><br>'+
				'<strong>活动占'+  this.point.times +'次,</strong><br>'
            }
	    },
	    plotOptions: {
            pie: {
 ...
 * @return {object}          返回 highcharts 对象
 */
function chart_pie_tooltip2(target,user,title, subtitle, data){
    var style = {
            title: {fontSize: '18px', color: '#586779'},
            subtitle: {fontSize: '40px', color: '#fff'}
        },
    ...
    var chart = $(target).highcharts({
        ...
        tooltip: {
            ...
            formatter: function() {
				...
				+  this.point.totlenum +'个,</strong><br>'
            }
	    },
	    plotOptions: {
            pie: {
