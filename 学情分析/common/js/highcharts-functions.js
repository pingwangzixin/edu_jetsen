...
function chart_column_stack(target, title, categories, ytitle, data, totalName, units, stackLabels){
    ...
    var check = true;
    var max = typeof categories != 'undefined' && categories.length <= 4 ? categories.length - 1 : 4;
	var scroll = typeof categories != 'undefined' && categories.length <=4 ? false : true;
        ...
        tooltip: {
            formatter: function() {
                if (tip_type == 1) {
                	...
                	return '<strong>'+ this.x +'</strong><br>'+
                    '<strong>'+ this.series.name +'：</strong>第'+ this.point.score + '名';
                } else {
                    return '<strong>'+ this.x +'</strong><br>';
                }
            }
                ...
                dataLabels: {
                    ...
                    formatter: function(){
                        if (tip_type == 1) {
                        	...
                        	return this.point.y + '%(第' + this.point.score + '名)';
                        } else {
                            return this.point.y;
                        }
                    }
