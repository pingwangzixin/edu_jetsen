	            ...
	            [
	                {
	                    ...
	                    "state":($location.path().indexOf('classCardWrap')!= -1 || $location.path().indexOf('DemeanorEdit')!= -1 || $location.path().indexOf('DemeanorDetails')!= -1 || $location.path().indexOf('publicEdit')!= -1 || $location.path().indexOf('publicDetails')!= -1) || false,
	                    "children":[]
	                },
	                {
	                    "id":"42",
	                ...
	                },
	                {
	                    "id":"43",
	                    "label":"安全管理",
	                    "url":"secondNav.leftTree.publicNav.safeIndex",
	                    "state":($location.path().indexOf('safeIndex')!= -1 || $location.path().indexOf('safeMore')!= -1) || false,
	                    "children":[]
	                }
	            ]
	        }
